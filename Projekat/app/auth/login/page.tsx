...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <span
        className="text-xs"
        style={{ color: 'rgb(var(--first-tertiary-rgb) / 0.6)' }}
      >
        {label}
      </span>
    </div>
    ...
    >
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <span
          ...
          style={{ color: 'rgb(var(--first-tertiary-rgb) / 0.85)' }}
        >
          {title}
        </span>
      </div>
    ...
    >
      ...
      >
        <Settings
          className="h-80 w-80"
          strokeWidth={0.8}
          style={{ color: 'var(--first-tertiary)' }}
        />
      </div>
      <div
        className="pointer-events-none absolute -bottom-20 -left-12 opacity-[0.05]"
        aria-hidden
      >
        <Wrench
          className="h-64 w-64"
      ...
      <div className="relative flex flex-col gap-8 p-10 xl:p-14">
        ...
        <div>
          ...
          <p
            ...
            style={{ color: 'rgb(var(--first-quaternary-rgb) / 0.75)' }}
          >
            Upravljanje intervencijama, serviseri na terenu i kompletna
            historija rada - sve na jednom mjestu.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <StatCard
            value="24"
            label="Aktivna naloga"
            color="var(--first-septenary)"
          />
          <StatCard
            value="12"
            label="Servisera na terenu"
            color="var(--first-secondary)"
          />
          <StatCard
            value="189"
            label="Završenih intervencija"
            color="var(--first-quaternary)"
          />
        </div>
        ...
        >
          ...
          <JobRow
            title="Vodoinstalaterski popravak - St. 204"
            time="1 sat"
            status="zavrseno"
          />
        ...
        <p
          className="text-xs"
          style={{ color: 'rgb(var(--first-tertiary-rgb) / 0.35)' }}
        >
          Koristi ga{' '}
          <span style={{ color: 'var(--first-septenary)' }}>
            1.200+ servisnih kompanija
          </span>{' '}
          u regionu
        </p>
      </div>
        ...
        <div className="relative z-10 w-full max-w-sm">
          ...
          >
            <div className="mb-6">
              ...
              >
                Prijavite se za pristup servisnom operativnom sistemu i aktivnim
                nalozima vaše firme.
              </p>
            </div>
