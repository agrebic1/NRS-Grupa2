      ...
      >
        ...
        <ChevronDown
          ...
          style={{
            ...
            transform: otvoren ? 'rotate(180deg)' : 'none',
          }}
        />
      </button>
        ...
        <>
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundColor: 'rgb(var(--first-quaternary-rgb) / 0.35)',
              }}
            />
            <button
              type="button"
  ...
  useEffect(() => {
    ...
    async function ucitajUloge() {
      try {
        ...
        const ulogeKorisnika = Array.isArray(podaci?.profil?.uloge)
          ? podaci.profil.uloge
          : [];
            ...
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs" style={{ color: boja }}>
                    {oznaka}
                  </p>
                </div>
              </div>
