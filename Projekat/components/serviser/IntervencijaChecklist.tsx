  ...
  return (
    ...
    >
      ...
      <span className="mt-0.5 flex-shrink-0">
        {oznacena ? (
          <CheckSquare
            style={{ color: ZELENA, width: '1.125rem', height: '1.125rem' }}
          />
        ) : (
          <Square
            style={{
      ...
      {highlightNepopunjena && !sveDone && (
        ...
        >
          ...
          <p
            ...
            style={{ color: CRVENA }}
          >
            Potrebno je označiti sve stavke kontrolne liste prije evidencije
            rada. Još {UKUPNO - brojOznacenih}{' '}
            {UKUPNO - brojOznacenih === 1
              ? 'stavka nije označena'
              : 'stavke nisu označene'}
            .
          </p>
        </div>
      )}
