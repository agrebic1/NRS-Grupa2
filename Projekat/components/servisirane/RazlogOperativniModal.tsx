      ...
      <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-xl">
        <div className="px-6 py-5 border-b" style={{ borderColor: 'rgb(var(--first-quaternary-rgb)/0.25)' }}>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              {ikona ?? <AlertTriangle className="h-4 w-4" style={{ color: '#D97706' }} />}
              <p className="font-bold" style={{ color: 'var(--first-octonary)' }}>{naslov}</p>
            </div>
            <button
              type="button"
              onClick={onZatvori}
        ...
        <div className="p-6 flex flex-col gap-4">
          ...
          >
            ...
            <p className="text-sm" style={{ color: 'var(--first-octonary)' }}>{upozorenje}</p>
          </div>
