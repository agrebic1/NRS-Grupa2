...
async function procitajPartnerApiResponse(
  odgovor: Response,
    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div className="relative">
        <div className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2">
          <Ikona
            className="h-4 w-4"
            style={{ color: error ? '#DC2626' : 'var(--first-nonary)' }}
          />
        </div>
        <input
          id={id}
...
export function PartnerApplicationForm() {
  ...
  async function posalji(podaci: PartnerFormData) {
    ...
    try {
      ...
      setGreska(
        err instanceof Error ? err.message : 'Greška pri slanju aplikacije.',
      );
    } finally {
      setUploading(false);
    }
  ...
  if (jeUspjelo) {
    return (
      <div className="flex flex-col items-center gap-4 py-10 text-center">
        ...
        >
          Vaša aplikacija je evidentirana. Administrator će je pregledati i
          kontaktirati vas na navedenu email adresu u roku od 24 sata.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
                ...
                >
                  ...
                  >
                    <Ikona
                      className="h-5 w-5"
                      style={{
                        color: jeAktivan ? boja : 'var(--first-nonary)',
                      }}
                    />
                  </div>
                  <div>
                    <p
                      ...
                      style={{
                        color: jeAktivan ? boja : 'var(--first-octonary)',
                      }}
                    >
                      {label}
                    </p>
            ...
            {SPECIALNOSTI.map(({ value, Ikona }) => {
              ...
              return (
                <button
                  ...
                  style={{
                    borderColor: jeOdabran
                      ? 'var(--first-senary)'
                      : 'rgb(var(--first-quaternary-rgb) / 0.4)',
                    backgroundColor: jeOdabran
                      ? 'rgb(var(--first-senary-rgb) / 0.08)'
                      : 'rgb(255 255 255 / 0.7)',
                    color: jeOdabran
                      ? 'var(--first-senary)'
                      : 'var(--first-octonary)',
      ...
      <div className="flex flex-col gap-1.5">
        ...
        {dokument ? (
          ...
          <div
            ...
            onClick={() =>
              document.getElementById('partner-doc-input')?.click()
            }
          >
            <Upload
              className="h-6 w-6"
      ...
      <Button
        ...
        isLoading={jeSlanje}
        loadingText={
          uploading ? 'Prijenos dokumenta...' : 'Slanje aplikacije...'
        }
        size="lg"
        className="w-full"
      >
